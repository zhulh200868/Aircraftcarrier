...
class t_exec_jid_detail(models.Model):
    ...
    donetime = models.DateTimeField(default = timezone.now,verbose_name="完成时间")
    def __str__(self):
...
class t_exec_mapping(models.Model):
    ...
    step_num = models.CharField(max_length=30,verbose_name="任务的步数")
    no = models.IntegerField(verbose_name="次数")
    task_id = models.CharField(max_length=50,verbose_name="任务号")
